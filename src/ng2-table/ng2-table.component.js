...
var Ng2TableComponent = (function () {
    ...
    Ng2TableComponent.prototype.rowClickedFn = function (dataRow, rowIndex) {
        this.activeRow = rowIndex;
        this.rowClicked.emit(dataRow);
    };
    Ng2TableComponent.prototype.cellItemClickedFn = function ($event, colSpec, row) {
        $event.stopPropagation(); // don't want to trigger "rowClickedFn" as well
        this.cellItemClicked.emit({ colSpec: colSpec, row: row });
    };
    Ng2TableComponent.prototype.searchUpdate = function (originalCol) {
